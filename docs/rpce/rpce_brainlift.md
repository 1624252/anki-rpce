...
- **Spiky POV 1:** Consistency is a trap — practicing one question format breeds a false sense of mastery, so the tool should *vary the format* even when the underlying content is the same.
...
- **Spiky POV 3:** The AI's job in this tool is to be an *examiner*, not a *tutor*.
